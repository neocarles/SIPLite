...
Begin VB.Form Cetak_DataGaji 
   ...
   Begin VB.Image Image1 
      Height          =   1350
      Left            =   300
      Picture         =   "Cetak_DataGaji.frx":03A6
      Stretch         =   -1  'True
      Top             =   960
      Width           =   1350
   End
End
Attribute VB_Name = "Cetak_DataGaji"
...
Private Sub ButtonPreview_Click()
    ...
    If OptBulan.Value = True Then
        MyRS.Open "SELECT departemen.keterangan as kdep,karyawan_gaji.id as gid,karyawan_gaji.kode as gkode,karyawan_gaji.nama as gnama,karyawan_gaji.basic_hk as ghk,karyawan_gaji.basic_gaji as ggaji,karyawan_gaji.hk_miss as gmiss," & _
                  " karyawan_gaji.hk_potongan as ghkpot, karyawan_gaji.hk_totpotong as gtotpot, karyawan_gaji.tunjangan as gtun, karyawan_gaji.potongan as gpot, karyawan_gaji.total_gaji as gtotgaji" & _
